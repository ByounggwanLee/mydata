 ...
 * @author 이병관
 */
@FeignClient(name = "IS01V2", url = "${prop.test.url}")
public interface Is01LegacyV2 {
	/*
	...
	Is01ReplyV2 getInsurances(@PathVariable(value = "authorization", required = false) String authorization,
	...
	List<InsuListV2> getInsuranceList(Is01RequestV2 isRequest);
}
