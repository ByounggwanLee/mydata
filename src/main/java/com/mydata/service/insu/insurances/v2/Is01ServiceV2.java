...
public class Is01ServiceV2 {
	final Is01LegacyV2 is01Legacy;
	 ...
	 */
	public Is01ReplyV2 getInsurances(String authorization, // 접근토큰
		...
		Is01RequestV2 is01Request = Is01RequestV2.builder().authorization(authorization).xApiTranId(xApiTranId)
