 ...
 * Business Name : Repository - 시간대별 통계목록 Repository 클래스(TbMdcos12Repository)
 * Class Name : TbMdcos12Repository.java
 * Description : 시간대별 통계목록 Repository 클래스
...
**/
package com.mydata.domain.repository;
...
/**
 * 시간대별 통계목록 Repository 클래스
 * 
 * @name_ko 시간대별 통계목록 Repository 클래스
 * @author 이병관
 **/
public interface TbMdcos12Repository extends JpaRepository<TbMdcos12, TbMdcos12PK> {
}
